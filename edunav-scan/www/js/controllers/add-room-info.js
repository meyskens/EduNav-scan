angular
    ...
    .controller("AddRoomInfoCtrl", addRoomInfoController)

addRoomInfoController.$inject = [
    "$scope",
    "BackendService",
    "$ionicLoading",
    "$stateParams",
...
function addRoomInfoController(
    $scope,
    BackendService,
    $ionicLoading,
    $stateParams,
    ...
    $scope.save = function() {
        ...
        BackendService.addRoom(
            $stateParams.mapID,
            $stateParams.x,
            $stateParams.y,
            $scope.roomInfo.name,
            $scope.roomInfo.comment
        ).then(response => {
            $ionicLoading.hide()
